        ...
        <div className={styles.firstContent}>
          ...
          <div className={styles.firstImgP}>
            ...
            <div className={styles.firstDes}>
              ...
              <p>
                TURBO Design Suite는 펌프, 컴프레서, 팬, 터빈 및 토크 컨버터와
                같은 모든 유형의 터보 기계 블레이드를 위한 고유한 공기역학 및
                유체역학 3D 설계 패키지입니다.
              </p>
              <p>
                RBOdesign Suite를 사용하면 성능을 최적화하고 신뢰성을 향상시키며
                다양한 터보 기계 구성 요소의 비용을 절감할 수 있습니다. 당사의
                소프트웨어는 펌프, 팬, 압축기, 터빈 및 토크 컨버터의 획기적인
                설계를 생성하도록 제작되었으며, 당사의 엔지니어는 이러한 모든
                응용 분야에 대한 솔루션을 찾는 데 고도로 숙련되고 경험이
                많습니다.
              </p>
              <button>구매 문의</button>
            </div>
          ...
          <div className={styles.secondDes}>
            <div>
              ...
              <p>
                ...
                블레이드용 비점성 공기 역학 및 유체 역학 설계 소프트웨어입니다.
                이 코드는 축, 혼합 흐름 및 원심 구성의 팬, 펌프, 압축기, 터빈 및
                토크 컨버터와 같은 모든 유형의 터보 기계에 적용 가능합니다.
              </p>
            </div>
            <div>
              <h3>02</h3>
              <p>
                ...
                자기학, 유체 및 열 전달, 전기 및 자기학 등 다양한 응용 분야를
                지원합니다.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                ...
                TURBOdesign Suite는 직관적인 사용자 인터페이스를 제공하여 설계
                및 분석 프로세스를 쉽게 배우고 사용할 수 있습니다.
              </p>
            </div>
            <div>
              <h3>05</h3>
        ...
        <div className={styles.fourContent}>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              <h3>어려운 흐름 문제 해결</h3>
              <p>
                ADT의 고유한 방법은 3D 압력장 측면에서 유체 흐름에 수행하려는
                작업을 식별하는 것부터 시작하여 해당 결과를 달성하기 위한 최적의
                형상을 도출합니다. 이를 통해 각 설계에 소요되는 시간이 크게
                단축됩니다.
              </p>
            </div>
          ...
          <div className={styles.fourImgP2}>
            <div className={styles.fourDes2}>
              ...
              <p>
                ...
                공간을 제한하는 경향이 있습니다. 우리의 3D 역설계 방법을 통해
                사용자는 기존 설계의 제약을 받지 않고 혁신적인 솔루션을 탐색하고
                어려운 문제를 해결할 수 있습니다.
              </p>
            </div>
          ...
          <div className={styles.fourImgP2}>
            <div className={styles.fourDes2}>
              ...
              <p>
                ...
                최적의 설계 입력 선택은 응용 분야마다 일반성을 갖습니다. 이는
                비전문가가 최소한의 지침으로 도구를 효과적으로 사용하면서도 동급
                최고의 효율성으로 설계를 달성할 수 있음을 의미합니다.
              </p>
            </div>
            <div className={styles.fourImg2}>
              <Image
