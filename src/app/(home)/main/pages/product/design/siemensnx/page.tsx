          ...
          <div className={styles.firstImgP}>
            ...
            <div className={styles.firstDes}>
              <p>
                ...
                제조(CAD/CAM) 소프트웨어입니다. 제품 개발의 모든 단계를 지원하는
                강력하고 유연한 도구 세트입니다.
              </p>
              <p>
                X는 다양한 산업 분야에서 사용되며, 자동차, 항공우주, 의료, 제조,
                에너지 등에서 널리 사용됩니다.
              </p>
              <button>구매 문의</button>
            </div>
          ...
          <div className={styles.secondDes}>
            <div>
              ...
              <p>
                ...
                효율적으로 협업하고 제품 개발 프로세스를 간소화할 수 있습니다.
              </p>
            </div>
            <div>
              <h3>02</h3>
            ...
            <div>
              ...
              <p>
                <strong>확장성 :</strong>
                NX는 다양한 요구 사항을 충족하기 위해 확장할 수 있습니다. 예를
                들어, 적층 제조, 인공 지능, 가상 현실과 같은 최신 기술을
                지원합니다.
              </p>
            </div>
          </div>
            ...
            <div className={styles.thirdImgP}>
              <div className={styles.thirdDes2}>
                <p>
                  ...
                  확보할 수 있도록 지원합니다. <br /> NX CAD 및 NX CAM 솔루션 을
                  사용하여 팀이 보다 효과적으로 협업하고 비교할 수 없는 정밀도로
                  혁신적인 고품질 제품을 더 빠르게 제공할 수 있도록 지원하십시오
                  .
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    제품 관리: 제품 데이터 관리(PDM), 협업, 프로젝트 관리, 의사
                    결정 지원 도구
                  </li>
                </ul>
              </div>
        ...
        <div className={styles.fourContent}>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              ...
              <p>
                강력하고 통합된 CAD(컴퓨터 지원 설계) 솔루션 제품군을 사용하여
                혁신을 가로막는 장벽을 제거하고, 제품 설계 효율성과 품질을
                높이며, 개발 비용을 절감하세요.
              </p>
              <Link
          ...
          <div className={styles.fourImgP2}>
            <div className={styles.fourDes2}>
              ...
              <p>
                ...
                고성능 부품 제조를 효과적으로 계획, 협업 및 실행할 수 있습니다.
              </p>
              <Link
