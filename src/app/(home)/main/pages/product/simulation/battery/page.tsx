              ...
              <div className={styles.fourImgP1}>
                <div className={styles.fourDes1}>
                  ...
                  <p>
                    ...
                    정확한 용량 상관 관계를 얻을 수 있습니다. 계산된 '빌드
                    보고서'는 예를 들어 셀의 최종 에너지 밀도 또는 무게를
                    확인하여 항목을 검증하는 데 매우 유용할 수도 있습니다.
                  </p>
                  <p>
              ...
              <div className={styles.fourImgP2}>
                <div className={styles.fourDes2}>
                  <p>
                    ...
                    중에 시간을 낭비하지 않고 배터리 모듈의 다중 물리 '디지털
                    트윈'을 사용하여 개발 주기에서 가능한 결함, 원치 않는 제어
                    동작 또는 안전 문제를 초기에 감지하는 것입니다. 과정에서
                    너무 늦게 발견되었습니다.
                  </p>
                </div>
