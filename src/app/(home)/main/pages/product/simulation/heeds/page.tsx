              ...
              <div className={styles.secondDes}>
                <div>
                  ...
                  <p>
                    ...
                    탐색 알고리즘을 사용하여 설계 공간을 효율적으로 탐색합니다.
                    이 알고리즘은 설계 공간을 자세히 파악하여 할당된 시간 내에
                    최고의 솔루션을 찾을 수 있도록 합니다.
                  </p>
                </div>
                <div>
                  <h3>02</h3>
                  <p>
                    ...
                    통합되어 설계 개념의 성능을 평가할 수 있습니다. 이러한
                    평가를 통해 설계 개념이 성능 요구사항을 충족하는지 여부를
                    확인할 수 있습니다.
                  </p>
                </div>
                <div>
                  <h3>03</h3>
                  <p>
                    <strong>최적화 :</strong> HEEDS는 설계 개념을 최적화하기
                    위한 다양한 최적화 알고리즘을 제공합니다. 이러한 알고리즘을
                    사용하여 설계 개념의 성능을 더욱 향상시킬 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={styles.thirdDes}>
                <div>
                  <p>
                    <strong>
                      ...
                      하드웨어 및 소프트웨어 리소스를 극대화하고, 혁신적인
                      솔루션을 위한 설계 공간을 효율적으로 탐색하는 동시에 성능
                      요구사항을 충족하기 위해 새로운 개념을 평가하여 제품 개발
                      프로세스를 가속화합니다.
                    </strong>
                  </p>
                </div>
                <div>
                  <p>
                    ...
                    인터페이스를 사용하여 HEEDS는 맞춤형 스크립팅 없이 많은
                    기술을 빠르고 쉽게 통합합니다. 데이터가 모델링과 시뮬레이션
                    제품 간에 자동으로 공유되어 성능 균형 및 설계 견고성을
                    평가할 수 있습니다.
                  </p>
                </div>
                <div>
                  <p>
                    ...
                    <br />
                    HEEDS는 기존 하드웨어에 대한 투자를 활용하여 사용 가능한
                    모든 하드웨어 리소스를 효율적으로 사용합니다. Windows 및
                    Linux 기반 워크스테이션 또는 클러스터를 현장 또는 해외에서
                    사용할 수 있을 뿐만 아니라 클라우드 컴퓨팅 리소스를 사용하여
                    혁신적인 제품 개발을 가속화할 수 있습니다.
                  </p>
                </div>
                <div>
                  <p>
                    예를 들어, 지오메트리 수정은 Windows 운영 체제가 설치된
                    랩톱에서 자동화할 수 있습니다. 구조 변형 시뮬레이션은 Linux
                    워크스테이션에서 수행할 수 있습니다. CFD(전산 유체 역학)
                    시뮬레이션은 Linux 클러스터 또는 클라우드의 여러 코어에서
                    수행할 수 있습니다.
                  </p>
                </div>
                <div>
                ...
                <div>
                  <p>
                    HEEDS에는 성능 요구사항 이상의 설계 개념을 효율적으로 찾기
                    위한 독점적인 설계 공간 탐색 기능이 있습니다. HEEDS를 통해
                    검색 전략을 자동으로 조정하여 설계 공간을 자세히
                    파악함으로써 할당된 시간 내에 최고의 솔루션을 찾을 수
                    있습니다. 사용하기 쉽고 마감일을 맞추도록 설계되었으며
                    상당한 가치를 제공할 수 있습니다.
                  </p>
                </div>
                <div>
                  <p>
                    ...
                    <br />
                    HEEDS는 특성과 견고성이 우수한 여러 설계의 성능을 쉽게
                    비교할 수 있는 기능을 제공합니다. 이를 통해 사용자는 다양한
                    플롯, 표, 그래프 및 이미지를 사용하여 상충하는 목표와 제약
                    조건 간의 설계 성능 균형을 시각화하며 인사이트를 얻고
                    혁신적인 솔루션을 파악할 수 있습니다. 또한 생산 준비가
                    완료된 설계를 쉽게 개발하여 진정한 디지털 트윈을 구현할 수
                    있습니다.
                  </p>
                </div>
            ...
            <div className={styles.fourContent}>
              ...
              <div className={styles.fourImgP1}>
                <div className={styles.fourDes1}>
                  ...
                  <ul>
                    <li>
                      다양한 CAD 및 CAE 소프트웨어와의 연계 인터페이스 제공
                    </li>
                    <li>상호 시뮬레이션 또는 순차적 워크플로우 지원</li>
                    <li>
                      다양한 소프트웨어와의 프로세스 자동화를 통한 폭 넓은 설계
                      공간 탐색
                    </li>
              ...
              <div className={styles.fourImgP2}>
                <div className={styles.fourDes2}>
                  ...
                  <p>
                    HEEDS 사용할 경우 기존 하드웨어 리소스를 효과적으로 활용 할
                    수 있습니다.
                  </p>
                  <ul>
                    <li>사용 가능한 계산 자원을 최대 활용</li>
                    <li>
                      다양한 수준의 병렬화(예: 워크플로우, 작업 및 코어)를
                      사용하여 시뮬레이션 처리 시간 단축
                    </li>
                    <li>
                      플랫폼 및 운영 체제 전반에 걸쳐 시뮬레이션 작업을 조율
                    </li>
                    <li>
              ...
              <div className={styles.fourImgP1}>
                <div className={styles.fourDes1}>
                  ...
                  <p>
                    전문적인 기술 지식 및 모델 단순화가 필요한 대부분의 기존
                    최적화 소프트웨어와 다르게, HEEDS는 모든 설계자와 엔지니어가
                    사용할 수 있습니다.
                  </p>
                  <ul>
                    <li>
                      설계안을 효과적으로 탐색하기 위한 설계 탐색기능 포함
                    </li>
              ...
              <div className={styles.fourImgP2}>
                <div className={styles.fourDes2}>
                  ...
                  <p>
                    HEEDS는 디자인 특성을 효과적을 비교할 수 있는 기능이
                    제공됩니다.
                    <br />
                    다양한 플롯, 테이블 ,그래프와 이미지들을 통하여 최적의
                    솔루션을 찾을 수 있습니다.
                  </p>
                  <ul>
