          ...
          <div className={styles.firstImgP}>
            ...
            <div className={styles.firstDes}>
              <p>
                ...
                형상데이터를 불러오고, 이를 통해 방열설계 및 열관리 성능을 시
                뮬레이션하는 프로그램으로 전기/전자 산업분야의 기구 및
                회로설계자가 개념설계 단계에서 전자 장비 및 제품에 대한 방
                열해석을 수행하고, PC core수 무제한, 3D Solid 형상을 포함한
                상태에서 사용가능, 격자수 무제한 등의 기능과, 그 결과에 근거하여
                최적화 알고리즘을 통한 설계최적화를 목적으로 합니다.
              </p>
              <p>
              ...
              <p>
                ...
                이용 사례 등을 갖추고 있으며, 전 세계 사용자의 약 98% 가
                추천하는 검증된 전기/전자분야 전용 열관리솔루션 입니다.
              </p>
              <button>구매 문의</button>
            </div>
          </div>
        ...
        <div className={styles.secondContent}>
          ...
          <div className={styles.secondDes}>
            <div>
              <h3>01</h3>
              <p>
                SmartPart™ (히트싱크, 팬, 인클로저, TEC, PCM 등의 라이브러리
                D/B)를 사용하여 모든 전자 제품에 대한 방열설계 map 을 쉽게 만들
                수 있습니다.
              </p>
            </div>
            <div>
              <h3>02</h3>
              <p>
                MCAD 및 ECAD로 모델링한 형상을 손쉽게 변환하여 사용이 가능하기
                때문에, 실제 형상 및 모든 PCB 레이아웃 정보에 근거한 정확한
                해석이 가능합니다.
              </p>
            </div>
            <div>
              <h3>03</h3>
              <p>
                Instamesh™ 는 형상이 복잡하고 수 천개의 부품이 구성되어 있어도
                쉽고, 빠르게 격자를 생성할 수 있습니다.
              </p>
            </div>
            <div>
              <h3>04</h3>
        ...
        <div className={styles.thirdContent}>
          ...
          <div className={styles.thirdSubContent}>
            ...
            <div className={styles.thirdDes}>
              <div>
                <p>
                  자동차, 철도차량, 항공 우주, 방산, 전자 및 반도체 등 모든 산업
                  분야에서 전자제품과 부품은 점점 고속화, 소형화, 복잡화 되면서
                  기계 및 전자 설계 흐름을 제한하고 전력 밀도를 높여 나가고
                  있습니다. 이로 인해 열을 효율적으로 제거하기가 그 어느 때 보다
                  어려워졌으며 제품의 성능 및 신뢰성 문제가 발생할 수 있습니다.
                  Simcenter Flotherm은 빠른 시간 내 제품의 방열설계 최적화를
                  가능하도록 하는 지멘스 최고의 열관리 해석 제품입니다
                </p>
              </div>
              <div>
                <p>
                  34년 이상 축적된 개발 및 사용자 피드백을 바탕으로 만들어진
                  Simcenter Flotherm은 전자 열 해석을 위한 선도적인 전자 냉각
                  시뮬레이션 소프트웨어 솔루션입니다. IC 패키지, PCB 및
        ...
        <div className={styles.fourContent}>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              ...
              <ul>
                <li>
                  nstaMeshTM™시스템 사용으로 격자 품질 걱정 없이 쉽고빠르 게
                  자동 격자 생성으로 해석 시간을 단축 합니다
                </li>
                <li>
                  데이터 통합을 위한 FloXML 모델 및 형상 정보 가져오기 기능이
                  가능합니다.
                </li>
              </ul>
            </div>
          ...
          <div className={styles.fourImgP2}>
            <div className={styles.fourDes2}>
              ...
              <ul>
                <li>
                  최적설계 자동화 소프트웨어 HEEDS 연계로 설계 시나리오 생성 및
                  해석을 통한 최적 모델 선정합니다.
                </li>
                <li>
                  Simcenter Flotherm과 동시 작동되며, NX 3D CAD에 외부 3D CAD
                  형상 매개 변수로 추가 가능합니다.
                </li>
              </ul>
            </div>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              ...
              <ul>
                <li>
                  전자장비 열관리 분석에는 IC 패키지와 이들이 발산하는 열이 존재
                  합니다.
                </li>
                <li>이 장치의 열 모델을 정확하게 파악하는것이 중요 합니다.</li>
                <li>
                  Simcenter Flotherm은 간단한 부품부터 복잡한 시스템까지, 모든
                  모델링 수준을 지원하며, 다양한 분석 옵션을 제공 합니다.
                </li>
              </ul>
            </div>
            <div className={styles.fourImg1}>
              <Image
                src="/images/flotherm6.jpg"
                alt=""
                fill
                style={{ objectFit: "cover" }}
              />
            ...
            <div className={styles.fourDes2}>
              ...
              <ul>
                <li>
                  ...
                  정확도를 유지하면서 더 빠른 속도로 해석하는 컴팩트 감소 차수
                  모델(Boundary-Condition-Independent Reduced-Order Models)을
                  생성할 수 있습니다.
                </li>
                <li>
                  광범위한 열 환경을 CFD로 해결하기에는 시간이 상당량 소모되기
                  때문에 Simcenter Flotherm의 BCI-ROM 기능을 사용하여 모델을
                  추출하여 반복계산을 통해 기존 방식보다 약 40,000배 빠른 해결
                  속도를 보입니다.
                </li>
              </ul>
            </div>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              <h3>
                방열 시뮬레이션 결과의 정밀도 향상을 위한 측정 <br /> 데이터와의
                자동 보정 기능
              </h3>
              <p>
          ...
          <div className={styles.fourImgP1}>
            <div className={styles.fourDes1}>
              ...
              <ul>
                ...
                <li>
                  Simcenter Flotherm XT는 Hyperlinx와 Co-Simulation하여 PI(Power
                  Integrity) 열 해석이 가능합니다.
                </li>
              </ul>
            </div>
            <div className={styles.fourImg1}>
              <Image
                src="/images/flotherm10.jpg"
                alt=""
                fill
                style={{ objectFit: "cover" }}
              />
