          ...
          <div className={styles.firstImgP}>
            ...
            <div className={styles.firstDes}>
              <p>
                ...
                범위의 열 전도성을 갖는 기타 재료의 열 특성을 측정하기 위한 ASTM
                D 5470을 완벽하게 준수하는 측정 시스템입니다.
                <br />
                ...
                <br />열 인터페이스 재료의 분석이 간단하고, 포괄적인 TIMA 5는
                높은 수준의 기능성과 탁월한 사용 편의성을 제공 합니다.
              </p>
              <button>구매 문의</button>
            </div>
          </div>
        ...
        <div className={styles.thirdContent}>
          ...
          <div className={styles.thirdImgP}>
            <div className={styles.thirdDes2}>
              <p>
                ...
                아니라 낮거나 중간 정도의 열 전도율을 갖는 기타 재료 등급의 열
                및 열-기계적 특성을 분석하기 위한 범용 시스템입니다.
                <br /> ASTM D5470는 업계 전반의 일반적으로 사용되는 TIM 특성화
                표준으로, 대부분의 애플리케이션 시나리오에 적응하는 데 필요한
                가변성을 제공합니다.
              </p>
              <p>
                실험실에 적합하며 컴팩트하고 모든 냉수 공급이 제공됩니다. 하루
                교육만으로 장치를 완전히 이해하고 모든 유형의 특성화 및 재료
                연구를 용이하게 수행할 수 있습니다.
              </p>
            </div>
          ...
          <div className={styles.thirdImgP}>
            ...
            <div className={styles.thirdDes2}>
              <p>
                ...
                재료별로 다르지만 두 번째 값은 상황에 가장 민감하며 현대 응용
                분야에서 그 중요성이 점점 더 커지고 있습니다. 특히 TIM 특성화의
                경우 ASTM D5470은 기존의 다른 방법보다 우수합니다. 일반적으로
                인터페이스 저항은 다음 매개변수에 따라 달라지며, 이 매개변수는
                모두 TIMA에서 구성 가능한 옵션입니다.
              </p>
              <ul>
          ...
          <div className={styles.thirdImgP}>
            <div className={styles.thirdDes2}>
              ...
              <p>
                샘플에 가해지는 힘을 제어하는 ​​동안 TIMA는 몇 미크론 분해능으로
                샘플 두께를 정밀하게 모니터링하여 재료 압축에 대한 정확한 정보를
                제공하고 샘플의 유효 열전도도를 모니터링합니다.
              </p>
            </div>
          ...
          <div className={styles.thirdImgP}>
            ...
            <div className={styles.thirdDes2}>
              <p>
                ...
                생산성을 높일 수 있습니다. ASTM D 5470 표준에 따른 다양한 두께의
                내구성 테스트와 페이스트나 갭 필러의 주기적인 검사를 포함합니다.
                모든 측정 데이터는 현장에서 바로 모니터링되고 저장되어, 관련
                소프트웨어를 통해 쉽게 확인이 가능합니다. 이를 통해 측정이나
                샘플의 노화 정도를 적시에 확인하고, 적절한 시점에 다음 단계로
                넘어가기 위한 결정을 할 수 있습니다. 이러한 과정은 시간을
                절약하고 개발 속도를 가속화하는 데 도움을 줍니다. TIMA
                소프트웨어는 회사의 표준 작업 절차를 마련하고, 측정의 반복성과
                비교 가능성을 높이는 데에도 유용합니다.
              </p>
