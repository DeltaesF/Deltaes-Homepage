        ...
        <div className={styles.firstContent}>
          ...
          <div className={styles.firstImgP}>
            ...
            <div className={styles.firstDes}>
              <p>
                NANOTEST TOCS는 특성화 칩, 칩 홀더, 전자 장치 및 사용자 친화적인
                측정 및 분석 소프트웨어를 포함하는 완벽한 솔루션입니다. 시스템은
                바로 사용할 수 있으며 몇 분 안에 재료 샘플의 특성을 분석할 수
                있습니다.
                <br />
        ...
        <div className={styles.thirdContent}>
          ...
          <div className={styles.thirdImgP}>
            <div className={styles.thirdDes2}>
              <p>
                젤, 페이스트, 액체와 같은 점성 물질의 시간 및 온도 의존적 ​​열
                재료 특성을 결정하는 것은 방법론적으로 매우 어렵습니다. 특히,
                열전도율과 확산율은 상당한 노력을 통해서만 정확하게 결정될 수
                있는 경우가 많습니다. TOCS는 3-오메가 방법을 사용하여 두 재료
                매개변수를 모두 결정하고 몇 분 내에 액체에서 점성 재료 샘플의 열
                특성을 분석할 수 있습니다. 샘플은 혁신적이고 사용하기 쉬운
                특성화 칩에 간단히 배치되며 열전도도 및 확산도 값은 TOCS의
                편리한 전기 측정 프로그램을 사용하여 결정됩니다.
              </p>
            </div>
          </div>
          <h2>온칩 가열</h2>
          <div className={styles.thirdImgP}>
            <div className={styles.thirdDes2}>
              <p>
                ...
                3개의 동일한 센서와 2개의 구불구불한 모양의 가열 요소가 포함되어
                있어 샘플에서 균일하지만 높은 온도를 생성하거나 샘플을 통해 온도
                구배를 생성할 수 있습니다. 이를 통해 다양한 조건에서 재료를
                테스트하고 경화 거동을 모니터링하며 3개의 센서를 동시에 사용하여
                온도 의존성을 측정하여 3개의 독립적인 결과를 제공할 수 있습니다.
              </p>
              <ul>
                <li>붕규산 유리 칩</li>
                <li>12 × 12mm² 크기</li>
          ...
          <div className={styles.thirdImgP}>
            ...
            <div className={styles.thirdDes2}>
              <p>
                3-오메가 방법의 양방향 모델 맞춤은 테스트된 재료의 열 전도성과
                확산성을 동시에 생성합니다. 특히 열전도율은 1분 이내에 확인
                가능합니다.
              </p>
            </div>
          </div>
