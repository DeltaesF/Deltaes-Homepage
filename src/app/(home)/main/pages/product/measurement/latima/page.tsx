...
export default function Latima() {
  ...
  const pdfUrls = [
    "https://drive.google.com/file/d/1315rCqGGklpUuBmOLlcIFngVrKv2ZLpV/view?usp=sharing",
    "https://drive.google.com/file/d/1MDzU7umaf6-XxvzATrXCi0N3iTHXqjQh/view?usp=sharing",
  ];
