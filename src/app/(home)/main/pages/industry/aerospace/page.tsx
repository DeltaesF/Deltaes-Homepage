            ...
            <div className={styles.firstDesWrapper}>
              ...
              <div className={styles.leftAlignContent}>
                ...
                <p>
                  ...
                  플랫폼과 시스템을 개발하고 있습니다. 정부는 새로운 항공기와
                  기술을 위해 인프라와 보안 시스템을 변화시키고 있습니다.
                  원동력은 항공우주 및 방위 제품 라이프사이클과 가치 사슬 전반에
                  걸쳐 협업적이고 동기화된 프로그램 관리를 통해 촉진되는
                  혁신입니다.
                </p>
              </div>
            </div>
      ...
      <div className={styles.firstSubContainer}>
        <div className={styles.firstSub}>
          <div className={styles.firstSubDes}>
            ...
            <p>
              디지털화의 속도는 전례가 없습니다. 이 모든 것은 고립된 데이터를
              연결된 분야 및 프로세스로 전환하는 디지털 스레드를 통해
              가능해집니다. 이러한 스레드는 물리적 세계를 반영하는 가상 엔터티인
              디지털 트윈의 신경 네트워크를 형성하여 데이터를 통찰력으로
              전환하여 제품 및 생산 라이프사이클 전반에 걸쳐 지속적으로 설계,
              구축 및 최적화합니다. <br /> <br />
              디지털화의 속도는 전례가 없습니다. 이 모든 것은 고립된 데이터를
              연결된 분야 및 프로세스로 전환하는 디지털 스레드를 통해
              가능해집니다. 이러한 스레드는 물리적 세계를 반영하는 가상 엔터티인
          ...
          <div className={styles.secondGrid}>
            <div className={styles.grid}>
              ...
              <div className={styles.textOverlay}>
                <h3>항공기 엔진</h3>
                <p>
                  상업용 항공기 및 군용 항공기를 위한 고성능 엔진을 개발 중인
                  OEM
                </p>
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.textOverlay}>
                ...
                <p>
                  항공 우주 및 방위 플랫폼을 위한 항공 전자 및 전자 장치 개발
                </p>
                <div className={styles.detailButton}>
                  <Link
                    href="https://xcelerator.siemens.com/global/en/industries/aerospace.html"
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.textOverlay}>
                <h3>우주 시스템</h3>
                <p>
                  오늘날의 우주 산업을 지원하는 발사 장치, 우주선, 위성 및 착륙
                  시스템
                </p>
                <div className={styles.detailButton}>
                  <Link
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.textOverlay}>
                ...
                <p>
                  방산 및 준군사 서비스를 위한 견고한 장갑 기능를 갖춘 모바일
                  지상 무기 플랫폼 및 시스템
                </p>
                <div className={styles.detailButton}>
                  <Link
      ...
      <div className={styles.secondSubContainer}>
        <div className={styles.secondSub}>
          ...
          <div className={styles.secondSubDes}>
            <p>
              비행의 진화는 많은 발전을 가져 왔습니다. 새로운 시대에 도달 할 수
              있는 무한한 기술과 경계없는 비행의 미래를 상상해보십시오. 신뢰할
              수 있는 항공 우주 및 국방 기업들은 업계 파트너로서 최고의 제품과
              세계적 수준의 프로그램을 제공 할 수 있음을 알고 있습니다. 실제
              세계와 디지털 세계를 하나로 모으는 디지털화는 필수적 입니다. 항공
              우주 및 방위 산업 고객의 미래에 대한 비전은 오늘날의 현실입니다
            </p>
          </div>
        </div>
      </div>
        ...
        <div className={styles.siemens}>
          <div className={styles.siemensDes}>
            ...
            <p>
              ...
              성공시키는데 필수적입니다. <br />
              Siemens 솔루션은 완벽한 계획, 재원 조달 및 예산 편성으로 구현한
              프로그램 관리 시스템에서 비용과 일정, 기술 요구사항을 통합해
              프로그램을 계획하고 실행하는 시스템 방식을 제공합니다. 이 솔루션은
              관리하기 쉬우며, 확장성이 뛰어나 어느 규모의 상용 및 관용
              프로그램에나 사용 가능합니다. 모든 프로그램 아티팩트를 관리하는
              통합 시스템을 사용해 비용과 일정에 맞게 실행할 수 있는 역량을
              강화할 수 있습니다.
            </p>
            <Link
        ...
        <div className={styles.siemens2}>
          <div className={styles.siemensDes2}>
            ...
            <p>
              ...
              위해서는 여러 단계, 도구 및 가공이 필요한 기존 제조 방법에 비해
              절감된 비용으로 최적의 성능을 제공할 수 있도록 모든 것을 개조할 수
              있습니다. 적층 제조를 위한 Siemens의 통합 소프트웨어
        ...
        <div className={styles.siemens3}>
          <div className={styles.siemensDes3}>
            ...
            <p>
              ...
              통합된 보기를 제공하는 플랫폼이 필요합니다. 강력한 설계 공간 탐색,
              확장 가능한 다중 물리학, 역학 및 CFD 기능, 업계 최고의 물리적
              테스트 및 숙련된 엔지니어링 서비스를 고유하게 결합함으로써 Siemens
              Digital Industry Software 포트폴리오는 모든 수준에서 엔지니어링
              통찰력을 제공합니다.
            </p>
            <Link
